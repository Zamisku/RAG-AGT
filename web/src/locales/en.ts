...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Conduct a retrieval test to check if 哈尔滨师范大学Agent系统 can recover the intended content for the LLM.',
      Parse: 'Parse',
      dataset: 'Dataset',
      ...
      rerankTip: `Optional. If left empty, 哈尔滨师范大学Agent系统 will use a combination of weighted keyword similarity and weighted vector cosine similarity; if a rerank model is selected, a weighted reranking score will replace the weighted vector cosine similarity. Please be aware that using a rerank model will significantly increase the system's response time. If you wish to use a rerank model, ensure you use a SaaS reranker; if you prefer a locally deployed rerank model, ensure you start 哈尔滨师范大学Agent系统 with docker-compose-gpu.yml.`,
      topK: 'Top-K',
...
**Essential Rules:**
  ...
  - **Always consider** the entire conversation history.`,
      ...
      **Essential Rules:**
      ...
      betaError:
        'Please acquire a 哈尔滨师范大学Agent系统 API key from the System Settings page first.',
      searching: 'Searching...',
      parsing: 'Parsing',
      uploading: 'Uploading',
...
Example: Virtual Hosted Style`,
      ...
      cloudServiceConfig: 'Cloud Service Configuration',
      cloudService: 'Cloud Services',
      aliyunOpenSearch: 'Aliyun OpenSearch',
      aliyunOpenSearchHosts: 'Aliyun OpenSearch Hosts',
      hostsRequired: 'Please enter the Aliyun OpenSearch hosts',
      passwordRequired: 'Please enter the password',
      deepseekDescription: 'DeepSeek LLM for chat and reasoning',
      dashscopeDescription: 'Aliyun DashScope embedding and AI models',
      siliconflowDescription: 'SiliconFlow - Unified API for LLMs and Embeddings',
      getApiKey: 'Get API Key',
      notConfigured: 'Not configured',
      configure: 'Configure',
      configureInModelPage: 'Configure in Model Settings',
      ...
      embeddingModelTip:
        'The default embedding model for each newly created dataset. If you cannot find an embedding model from the dropdown, check if you are using 哈尔滨师范大学Agent系统 slim edition (which does not include embedding models) or check https://ragflow.io/docs/dev/supported_models to see if your model provider supports this model.',
      img2txtModel: 'VLM',
      img2txtModelTip:
