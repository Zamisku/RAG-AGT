  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'قم بإجراء اختبار استرجاع للتحقق مما إذا كان 哈尔滨师范大学Agent系统 يمكنه استرداد المحتوى المقصود لـ LLM.',
      Parse: 'تحليل',
      dataset: 'مجموعة البيانات',
      ...
      rerankTip:
        'خياري. إذا تركت فارغة، فسوف يستخدم 哈尔滨师范大学Agent系统 مجموعة من تشابه الكلمات الرئيسية الموزونة وتشابه جيب التمام المتجه الموزون؛ إذا تم تحديد نموذج إعادة الترتيب، فستحل درجة إعادة الترتيب المرجحة محل تشابه جيب تمام المتجه المرجح. يرجى العلم أن استخدام نموذج إعادة الترتيب سيؤدي إلى زيادة وقت استجابة النظام بشكل كبير. إذا كنت ترغب في استخدام نموذج إعادة الترتيب، فتأكد من استخدام أداة إعادة ترتيب SaaS؛ إذا كنت تفضل نموذج إعادة الترتيب المنشور محليًا، فتأكد من بدء تشغيل 哈尔滨师范大学Agent系统 باستخدام docker-compose-gpu.yml.',
      topK: 'توب ك',
      topKTip:
    ...
    chat: {
      ...
      betaError:
        'يرجى الحصول على مفتاح 哈尔滨师范大学Agent系统 API من صفحة إعدادات النظام أولاً.',
    ...
    setting: {
      ...
      embeddingModelTip:
        'نموذج التضمين الافتراضي لكل قاعدة معرفية تم إنشاؤها حديثًا. إذا لم تتمكن من العثور على نموذج التضمين من القائمة المنسدلة، فتحقق مما إذا كنت تستخدم إصدار 哈尔滨师范大学Agent系统 النحيف (الذي لا يتضمن نماذج التضمين) أو تحقق من https://ragflow.io/docs/dev/supported_models لمعرفة ما إذا كان موفر النموذج الخاص بك يدعم هذا النموذج.',
      img2txtModel: 'VLM',
      img2txtModelTip:
