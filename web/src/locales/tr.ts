...
Örnek: 1024 boyutlu embedding ile 1 KB\'lık bir mesaj ~9 KB kullanır. 5 MB varsayılan sınır ~500 mesaj tutar.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        "哈尔滨师范大学Agent系统'nun LLM için hedeflenen içeriği alıp alamadığını kontrol etmek için bir alım testi yapın.",
      Parse: 'Ayrıştır',
      dataset: 'Dataset',
      testing: 'Alım testi',
      files: 'dosyalar',
      ...
      similarityThresholdTip:
        '哈尔滨师范大学Agent系统, alım sırasında ağırlıklı anahtar kelime benzerliği ile ağırlıklı vektör kosinüs benzerliğinin veya ağırlıklı yeniden sıralama puanının kombinasyonunu kullanır. Bu parametre, kullanıcı sorgusu ile parçalar arasındaki benzerlik eşiğini belirler. Bu eşiğin altında benzerlik puanına sahip parçalar sonuçlardan çıkarılır. Varsayılan eşik 0.2 olarak ayarlanmıştır, yani yalnızca 20 veya daha yüksek hibrit benzerlik puanına sahip parçalar alınacaktır.',
      ...
      uploadDescription:
        'Tekil veya toplu dosya yüklemeyi destekler. Yerel olarak dağıtılan 哈尔滨师范大学Agent系统 için: yükleme başına toplam dosya boyutu sınırı 1GB, 32 dosyalık toplu yükleme sınırı vardır. Hesap başına toplam dosya sayısında sınır yoktur. cloud.ragflow.io için yükleme başına toplam dosya boyutu sınırı 10MB, her dosya en fazla 10MB ve hesap başına en fazla 128 dosya.',
      chunk: 'Parça',
      bulk: 'Toplu',
      cancel: 'İptal',
      close: 'Kapat',
      ...
      rerankTip: `İsteğe bağlı. Boş bırakılırsa 哈尔滨师范大学Agent系统 ağırlıklı anahtar kelime benzerliği ve ağırlıklı vektör kosinüs benzerliğinin kombinasyonunu kullanır; yeniden sıralama modeli seçilirse ağırlıklı yeniden sıralama puanı ağırlıklı vektör kosinüs benzerliğinin yerini alır. Yeniden sıralama modeli kullanmanın sistemin yanıt süresini önemli ölçüde artıracağını unutmayın. Yeniden sıralama modeli kullanmak istiyorsanız bir SaaS yeniden sıralayıcı kullandığınızdan emin olun; yerel olarak dağıtılmış yeniden sıralama modelini tercih ediyorsanız 哈尔滨师范大学Agent系统'u docker-compose-gpu.yml ile başlattığınızdan emin olun.`,
      topK: 'Top-K',
...
**Temel Kurallar:**
  ...
  - **Her zaman** konuşma geçmişinin tamamını göz önünde bulundurun.`,
      ...
      **Temel Kurallar:**
      ...
      variable: 'Değişken',
      variableTip: `哈尔滨师范大学Agent系统\'nun sohbet asistanı yönetim API\'leri ile birlikte kullanılır.`,
      add: 'Ekle',
      key: 'Anahtar',
      ...
      betaError:
        'Lütfen önce Sistem Ayarları sayfasından bir 哈尔滨师范大学Agent系统 API anahtarı edinin.',
      searching: 'Aranıyor...',
    ...
    setting: {
      ...
      embeddingModelTip:
        'Her yeni oluşturulan dataset için varsayılan embedding model. Açılır listede bir embedding model bulamıyorsanız, 哈尔滨师范大学Agent系统 slim sürümünü (embedding modeller içermez) kullanıp kullanmadığınızı kontrol edin veya model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://ragflow.io/docs/dev/supported_models adresine bakın.',
      img2txtModel: 'VLM',
      img2txtModelTip:
    ...
    fileManager: {
      ...
      uploadTitle: 'Yüklemek için dosyanızı buraya sürükleyip bırakın',
      uploadDescription:
        'Tekil veya toplu dosya yüklemeyi destekler. Yerel 哈尔滨师范大学Agent系统 için 1GB sınır, 32 dosya toplu yükleme sınırı.',
