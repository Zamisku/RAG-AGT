...
Beispiel: Eine 1 KB Nachricht mit 1024-dim Einbettung verwendet ~9 KB. Das Standardlimit von 5 MB fasst ~500 solcher Nachrichten.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Führen Sie einen Abruftest durch, um zu prüfen, ob 哈尔滨师范大学Agent系统 die beabsichtigten Inhalte für das LLM wiederherstellen kann.',
      Parse: 'Analysieren',
      dataset: 'Datensatz',
      testing: 'Abruftest',
      files: 'Dateien',
...
<p>Siehe https://ragflow.io/docs/dev/use_tag_sets für Details.</p>
    ...
    chat: {
      ...
      betaError:
        'Bitte erwerben Sie zuerst einen 哈尔滨师范大学Agent系统-API-Schlüssel auf der Systemeinstellungsseite.',
      searching: 'Suche...',
      parsing: 'Analysiere',
      uploading: 'Hochladen',
